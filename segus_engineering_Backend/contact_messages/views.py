...
class ContactMessageViewSet(viewsets.ModelViewSet):
    ...
    def mark_as_read(self, request, pk=None):
        ...
        return Response(
            {"message": "Message marqué comme lu", "data": self.get_serializer(message).data}
        )
    ...
    def mark_as_replied(self, request, pk=None):
        ...
        return Response(
            {"message": "Message marqué comme répondu", "data": self.get_serializer(message).data}
        )
    ...
    def stats(self, request):
        ...
        status_stats = (
            ContactMessage.objects.values("status").annotate(count=Count("id")).order_by("status")
        )

        # Répartition par priorité
        priority_stats = (
            ContactMessage.objects.values("priority")
