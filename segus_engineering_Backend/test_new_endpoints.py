...
from employees.models import Employee, WorkSession  # noqa: E402
...
def test_models():
    ...
    try:
        ...
        assert False, f"Erreur lors du test des modèles: {e}"
...
def test_serializers():
    ...
    try:
        ...
        assert False, f"Erreur lors du test des serializers: {e}"
...
def test_views():
    ...
    try:
        from employees.views import EmployeeWorkStatsViewSet  # noqa: E402
        ...
        assert False, f"Erreur lors du test des vues: {e}"
...
def test_database():
    ...
    try:
        ...
        assert False, f"Erreur lors du test de la base de données: {e}"
...
def main():
    ...
    tests = [test_models, test_serializers, test_views, test_database]
