...
from gamification.models import (
    ...
    MonthlyPerformance, EmployeeStats, Badge, EmployeeBadge
)
...
def test_rajeh_scenario():
    ...
    for day in range(20):
        ...
        print(f"  Jour {day+1}: ⭐ {performance.daily_stars_earned} étoile, "
    ...
    for badge in available_badges:
        if (stats.total_stars >= badge.required_stars and 
            stats.total_points >= badge.required_points):
