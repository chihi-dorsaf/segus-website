...
class JobOffer(models.Model):
    ...
    experience_level = models.CharField(
        max_length=50, choices=EXPERIENCE_LEVELS, verbose_name="Niveau d'expérience"
    )
    ...
    application_deadline = models.DateTimeField(
        null=True, blank=True, verbose_name="Date limite de candidature"
    )
...
class JobApplication(models.Model):
    ...
    phone = models.CharField(
        max_length=20,
        validators=[
            RegexValidator(regex=r"^\+?1?\d{9,15}$", message="Format de téléphone invalide")
        ],
    ...
    status = models.CharField(
        max_length=20, choices=APPLICATION_STATUS, default="new", verbose_name="Statut"
    )
