...
class JobOfferAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Description", {"fields": ("description", "requirements", "skills")}),
        (
            "Salaire",
            {
    ...
    def new_applications_count(self, obj):
        ...
        if count > 0:
            url = (
                ...
                + f"?job_offer__id__exact={obj.id}&status__exact=new"
            )
            return format_html(
                '<a href="{}" style="color: #e74c3c; font-weight: bold;">{} nouvelles</a>',
                url,
                count,
            )
        return "0 nouvelles"
...
class JobApplicationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Liens",
            {"fields": ("portfolio_url", "linkedin_url"), "classes": ("collapse",)},
        ),
        (
            "Statut et suivi",
        ...
        (
            "Entretien",
            {"fields": ("interview_date", "interview_notes"), "classes": ("collapse",)},
        ),
        (
            "Métadonnées",
            {
        ...
        (
            "Historique",
            {"fields": ("status_history_display",), "classes": ("collapse",)},
        ),
    )
        ...
        if change:
            ...
            if old_obj.status != obj.status:
                ApplicationStatusHistory.objects.create(
                    ...
                    notes="Changement via admin Django",
                )
