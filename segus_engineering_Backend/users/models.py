...
class User(AbstractUser):
    ...
    profile_photo = models.ImageField(
        upload_to="user_photos/", null=True, blank=True, verbose_name="Photo de profil"
    )
    ...
    emergency_contact = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="Contact d'urgence"
    )
    emergency_phone = models.CharField(
        max_length=20, null=True, blank=True, verbose_name="Téléphone d'urgence"
    )
