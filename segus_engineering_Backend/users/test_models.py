...
class PasswordResetCodeModelTest(TestCase):
    ...
    def test_create_password_reset_code(self):
        ...
        reset_code = PasswordResetCode.objects.create(user=self.user, code="123456")
    ...
    def test_multiple_codes_per_user(self):
        ...
        code1 = PasswordResetCode.objects.create(user=self.user, code="111111")
        code2 = PasswordResetCode.objects.create(user=self.user, code="222222")
