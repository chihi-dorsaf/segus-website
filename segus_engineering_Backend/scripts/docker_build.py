...
def main():
    ...
    run_command(f"docker-compose -f {compose_file} down", "Arrêt des services existants", check=False)
    
    # Démarrer les services
    success = run_command(f"docker-compose -f {compose_file} up -d", f"Démarrage des services ({compose_file})")
