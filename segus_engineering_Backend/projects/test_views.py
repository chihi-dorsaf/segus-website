...
class ProjectViewSetTest(APITestCase):
    ...
    def test_assign_employees_to_project(self):
        ...
        assign_data = {
            'assigned_employees': [self.employee_user.id]
        }
...
class SubTaskViewSetTest(APITestCase):
    ...
    def test_mark_subtask_completed(self):
        ...
        response = self.client.post(
            f'{self.subtasks_url}{self.subtask.id}/mark_completed/',
            format='json'
        )
    ...
    def test_mark_subtask_uncompleted(self):
        ...
        response = self.client.post(
            f'{self.subtasks_url}{self.subtask.id}/mark_uncompleted/',
            format='json'
        )
    ...
    def test_filter_subtasks_by_completion_status(self):
        ...
        completed_subtask = SubTask.objects.create(
        ...
        response = self.client.get(f'{self.subtasks_url}?is_completed=true')
    ...
    def test_assign_employees_to_subtask(self):
        ...
        response = self.client.patch(
            f'{self.subtasks_url}{self.subtask.id}/',
            assign_data,
            format='json'
        )
