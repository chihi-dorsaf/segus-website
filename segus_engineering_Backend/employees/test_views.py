...
class EmployeeViewSetTest(APITestCase):
    ...
    def test_create_employee_as_admin(self):
        ...
        new_employee = Employee.objects.get(user__email="newemployee@example.com")
    ...
    def test_update_employee_as_admin(self):
        ...
        update_data = {"position": "Senior Développeur", "salary": 3000.000}

        response = self.client.patch(
            f"{self.employees_url}{self.employee.id}/", update_data, format="json"
        )
    ...
    def test_delete_employee_as_admin(self):
        ...
        temp_user = User.objects.create_user(
            username="tempemployee", email="temp@example.com", password="temppass123"
        )
    ...
    def test_employee_cannot_delete_employee(self):
        ...
        other_user = User.objects.create_user(
            username="otheremployee", email="other@example.com", password="otherpass123"
        )
...
class WorkSessionViewSetTest(APITestCase):
    ...
    def setUp(self):
        ...
        # Créer un profil employé
        self.employee = Employee.objects.create(user=self.employee_user, position="Développeur")
    ...
    def test_pause_work_session(self):
        ...
        response = self.client.post(f"{self.work_sessions_url}{session.id}/pause/", format="json")
    ...
    def test_resume_work_session(self):
        ...
        response = self.client.post(f"{self.work_sessions_url}{session.id}/resume/", format="json")
    ...
    def test_end_work_session(self):
        ...
        response = self.client.post(f"{self.work_sessions_url}{session.id}/end/", format="json")
