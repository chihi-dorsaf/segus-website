...
class EmployeeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Employee
        fields = [
            'id', 'user', 'matricule', 'position', 
            'phone', 'address', 'birth_date', 'hire_date', 'salary', 
...
class EmployeeCreateSerializer(serializers.ModelSerializer):
    ...
    generate_password = serializers.BooleanField(write_only=True, default=True, required=False, help_text="Générer automatiquement un mot de passe sécurisé")

    class Meta:
        model = Employee
        fields = [
            'email', 'first_name', 'last_name', 'generate_password',
            'position', 'phone', 'address', 'birth_date',
            'hire_date', 'salary'
        ]
    ...
    def validate(self, data):
        ...
        for field in ['phone', 'address', 'gender', 'emergency_contact', 'emergency_phone', 'notes']:
            ...
            with transaction.atomic():
                ...
                if generate_password:
                    ...
                    if not email_sent:
                        ...
                        logger.warning(f"[EmployeeSerializer] Impossible d'envoyer l'email de bienvenue a {employee.email}")
...
class EmployeeExportSerializer(serializers.Serializer):
    def to_csv(self, employees):
        ...
        # En-têtes
        headers = [
            'Matricule', 'Nom Complet', 'Email', 'Position', 'Département',
...
class WorkSessionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = WorkSession
        fields = [
            'id', 'employee', 'employee_name', 'start_time', 'end_time',
            'total_work_time', 'status', 'notes', 'duration_formatted',
...
class WorkSessionDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'employee', 'employee_name', 'start_time', 'end_time',
            'total_work_time', 'status', 'notes', 'duration_formatted',
            'pause_start_time', 'total_pause_time', 'pause_duration_formatted',
            'net_work_time', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'start_time', 'created_at', 'updated_at']
