...
class Employee(models.Model):
    ...
    matricule = models.CharField(
        max_length=20, unique=True, verbose_name="Matricule", blank=True, null=True
    )
...
class WorkSession(models.Model):
    ...
    total_work_time = models.DurationField(
        null=True, blank=True, verbose_name="Temps total de travail"
    )
    # Gestion des pauses
    ...
    total_pause_time = models.DurationField(
        null=True, blank=True, default=timedelta(0), verbose_name="Temps total de pause"
    )
    status = models.CharField(
        max_length=20, choices=SESSION_STATUS, default="active", verbose_name="Statut"
    )
