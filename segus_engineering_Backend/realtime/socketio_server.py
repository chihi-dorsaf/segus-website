...
def get_current_stats():
    ...
    try:
        ...
        stats = {
            ...
            'connected_employees': len([c for c in active_connections.values() if c['user_role'] == 'EMPLOYE']),
            'connected_admins': len([c for c in active_connections.values() if c['user_role'] == 'ADMIN']),
